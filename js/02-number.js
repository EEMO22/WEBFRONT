//  JavaScript의 Number
//  int, float 가리지 않고, 산술 연산 가능
let n1 = 2021;  //  Literal
let n2 = Number(2021);  //  Number 객체
...
console.log("011", parseInt("011", 2)); //  2진수 011을 반환
...
//  ★ 중요: NaN - 숫자로 변환할 수 없는 문자열을 반환하면 NaN(Not A number)
let v = parseInt("abc12345678");
